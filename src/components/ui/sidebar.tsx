...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-black border-r border-gray-800 text-white w-[300px] flex-shrink-0",
        className
      )}
      animate={{
...
export const SidebarLink = ({
  ...
  // Use React Router Link if href doesn't start with # or http, otherwise use regular anchor
